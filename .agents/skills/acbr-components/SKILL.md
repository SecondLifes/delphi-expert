...
> **Interface GUIDs:** always generate a fresh, real GUID for new interfaces (IDE: `Ctrl+Shift+G`, or `TGUID.NewGuid.ToString`) — never emit the literal placeholder text `{GUID}`.
...
type
  INFeEmissor = interface
    ['{4D5C14E2-754E-478A-A68E-1A7032AEE3E8}']
