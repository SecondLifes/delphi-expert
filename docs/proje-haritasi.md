...
| `python` | AI'nin yardımcı script yazması gerektiğinde (ör. bir analiz sonucunu işleyen tek seferlik bir script) kullanılır. | Delphi'ye özgü değil, genel amaçlı. |
