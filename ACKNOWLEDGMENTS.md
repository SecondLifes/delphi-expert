...
| [TMS FlexCel](https://www.tmssoftware.com/site/flexcel.asp) (TMS Software) | Excel/PDF/HTML generation library — the `flexcel-vcl` skill teaches the `TXlsFile` and `TFlexCelReport` APIs for Delphi | Commercial license required; no Office/Excel installation needed at runtime |
